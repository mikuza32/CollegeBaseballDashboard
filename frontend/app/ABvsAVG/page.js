...
export default function ABvsAVG() {
    ...
    useEffect(() => {
        ...
        setChartData({
            datasets: [
                {
                    label: 'At Bats vs Batting Average',
                    data: scatterPlot,
    ...
    return (
        <div className=" min-h-screen bg-black text-gray-50 p-6 rounded-lg shadow-lg  overflow-x-auto">
            ...
            <h1 className=" text-4xl font-extrabold text-center mb-10">NCAA Division 1 Baseball: At Bats vs. Batting Average</h1>
            {chartData ? (
