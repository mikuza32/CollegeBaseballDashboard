...
export default function BAvsHits() {
    ...
    const chartOptions = {
        ...
        scales: {
            ...
            y: {
                title: {display: true, text: 'Batting Average', color: '#e0e0e0'},
                ticks: {color: '#e0e0e0'},
                grid: {color: 'rgba(255,255,255,0.1)'},
            },
        },
    ...
    return (
        <div className=" min-h-screen bg-black text-gray-50 p-6 rounded-lg shadow-lg  overflow-x-auto">
            ...
            <h1 className=" text-4xl font-extrabold text-center mb-10">NCAA Division 1 Baseball: Batting Average vs. Hits</h1>
            {chartData ? (
