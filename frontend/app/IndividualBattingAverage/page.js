...
export default function IndividualBattingAverageCharts() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                console.error("Could not fetch individual batting averages", error);
            }
        }
        fetchData();
    }, []);
    ...
    useEffect(() => {
        ...
        let sortedData = [...data];
        if (order === "Ascending") {
          sortedData.sort((a, b) => parseFloat(a.BA) - parseFloat(b.BA));
        } else if (order === "Descending") {
          sortedData.sort((a, b) => parseFloat(b.BA) - parseFloat(a.BA));
        ...
        setChartData({
            ...
            datasets: [
                {
                    label: "Individual Batting Average",
                    data: dataset,
    ...
    return (
        <div className="bg-black text-gray-200 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-4">Individual Batting Average</h2>
            <select
          ...
          <Bar
            ...
            options={{
              ...
              plugins: {
                ...
                title: {
                  display: true,
                  text: 'Names and Batting Average',
                  color: '#e0e0e0',
                },
              },
              scales: {
