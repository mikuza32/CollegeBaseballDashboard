...
export default function IPvsER() {
    ...
    useEffect(() => {
        ...
        setChartData({
            datasets: [
                {
                    label: 'Innings Pitched vs. Earned Runs Allowed',
                    data: scatterPlot,
    ...
    const chartOptions = {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Innings Pitched vs. Earned Runs Allowed',
                color: '#e0e0e0',
            },
            legend: {
                labels: {color: '#e0e0e0'},
    ...
    return (
        <div className=" min-h-screen bg-black text-gray-50 p-6 rounded-lg shadow-lg  overflow-x-auto">
            ...
            <h1 className=" text-4xl font-extrabold text-center mb-10">NCAA Division 1 Baseball: Innings Pitched vs. Earned Runs Allowed</h1>
            {chartData ? (
